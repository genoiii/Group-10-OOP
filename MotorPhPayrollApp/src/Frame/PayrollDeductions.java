...
public class PayrollDeductions extends javax.swing.JFrame {
    ...
    public PayrollDeductions(PayPeriod payPeriod) {
        initComponents();  
        ...
        jTablePayrollEmployeeEarnings.setModel(payrollService.getPayrollEmployeeDeductionsTableModel(payPeriod));

    }

    public PayrollDeductions(Admin admin, PayPeriod payPeriod) {
        initComponents();
        this.admin = admin;
        this.payrollPayPeriod = payPeriod;
        jPanel1.setVisible(false);
    ...
    try {
        ...
        java.util.logging.Logger.getLogger(PayrollDeductions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    }
...
//    User loggedInUser = new Admin("adminUsername", "adminPassword");  // Example: Creating an Admin object
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            new PayrollDeductions().setVisible(true); 
